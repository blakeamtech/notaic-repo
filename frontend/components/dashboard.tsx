...
export function DashboardPage() {
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      const response = await fetch('https://api.notaic.site/account/emails/save-draft', {
        method: 'POST',
        headers: {
  ...
  const handleSendDraft = async (draft: Draft) => {
    ...
    try {
      const response = await fetch('https://api.notaic.site/account/emails/send-draft', {
        method: 'POST',
        headers: {
          'Authorization': `Bearer ${token}`,
          'Content-Type': 'application/json',
  ...
  const handleGmailAuth = async () => {
    ...
    try {
      const response = await fetch('https://api.notaic.site/auth/google-auth', {
        method: 'GET',
        headers: {
